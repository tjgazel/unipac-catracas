        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('gerenciar-usuarios.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control{{ $errors->has('tipo_usuario') ? ' is-invalid' : '' }}"
                                            name="tipo_usuario" value="{{ old('tipo_usuario') }}" id="tipo_usuario">
                                        <option value="2" {{old('tipo_usuario') == 2 ? 'selected' : ''}}>Usuário</option>
                                        <option value="1" {{old('tipo_usuario') == 1 ? 'selected' : ''}}>Admin</option>
                                    </select>
